// Clone from https://github.com/ocavue/prosemirror-virtual-cursor
...
export function cursor(options?: VirtualCursorOptions): Plugin {
  const skipWarning = options?.skipWarning ?? false;

  let _cursor: HTMLElement = document.createElement("div");
